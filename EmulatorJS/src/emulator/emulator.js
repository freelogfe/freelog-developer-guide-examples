import { initializeEmulator } from './core.js';
import { handleControls } from './controls.js';
import { createUI } from './ui.js';
import { manageSettings } from './settings.js';
import { handleNetworking } from './netplay.js';

/**
 * Main EmulatorJS function - replaces the class-based approach
 * @param {HTMLElement|string} element - Container element or selector
 * @param {Object} config - Emulator configuration
 */
export function EmulatorJS(element, config) {
    ...
    handleControls(emulator);
    createUI(emulator);
    manageSettings(emulator);
    handleNetworking(emulator);
