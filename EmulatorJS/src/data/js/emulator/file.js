// File handling functionality for EmulatorJS

export function downloadFile(emulator, path, progressCB, notWithPath, opts) {
...
export function toData(emulator, data, rv) {
