...
const distDir = path.join(rootDir, 'dist-esm');
const dataDir = path.join(rootDir, 'data');
const srcDir = path.join(rootDir, 'src');

console.log('Building EmulatorJS as ESM package...');
...
console.log('Preparing package.json for ESM...');
...
// 构建 ESM 入口文件
console.log('Building ESM entry files...');
buildEntryFiles();
...
console.log('ESM package build completed successfully!');
...
function buildEntryFiles() {
  // 创建 ESM 入口文件
  const esmEntry = `/**
 * EmulatorJS - ESM Bundle
 * 
 * This is the ESM entry point for the EmulatorJS npm package.
 */

export { EmulatorJS, createEmulator, destroyEmulator } from './src/index.js';
export default { EmulatorJS, createEmulator, destroyEmulator };
`;

  fs.writeFileSync(path.join(distDir, 'index.js'), esmEntry);
...
const { EmulatorJS, createEmulator, destroyEmulator } = require('./src/index.js');
